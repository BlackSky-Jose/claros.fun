      ...
      >
        ...
        <div
          ...
          style={{
            ...
            width: '40px',
            height: '8px',
            background: 'linear-gradient(45deg, #C699F5, #B476F2, #C699F5)',
            borderRadius: '4px',
            border: '1px solid #9850D9',
            boxShadow: '0 0 15px rgba(180, 118, 242, 0.8), 0 0 25px rgba(180, 118, 242, 0.6), inset 0 0 10px rgba(255, 255, 255, 0.3)',
